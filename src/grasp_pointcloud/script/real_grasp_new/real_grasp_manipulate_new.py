...
END = [0.9221269488334656, -0.6543424765216272, 0.8431277275085449, -1.7985013167010706, -1.584637467061178, -0.10116988817323858]
    ...
    def callback(self, array):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                rospy.sleep(2)
                self.arm.set_joint_value_target(END)
                self.arm.go(wait = True)
                rospy.set_param("/robotiq_command",'o')
                rospy.sleep(2)
