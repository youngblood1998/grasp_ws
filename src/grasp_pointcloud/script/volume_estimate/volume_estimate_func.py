...
def compute_strawberry_main_direction_and_histogram(pcd):
    # 直通滤波
    # 定义过滤范围
    ...
    # 计算点云深度直方图
    # 统计直方图
    hist, bin_edges = np.histogram(points[:, 2], bins=12, range=(-0.025, 0.025))
    return (hist, center, main_direction)
